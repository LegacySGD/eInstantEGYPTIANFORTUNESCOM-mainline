...
public class EGYPTIANFORTUNESCOMEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EGYPTIANFORTUNESCOMEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EGYPTIANFORTUNESCOMIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EGYPTIANFORTUNESCOMIW/InitOutcome.xml").getDocumentElement();
